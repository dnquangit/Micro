...
{
    public class RepoBase<T, K, TContext> : IRepoBase<T, K, TContext> where T : EntityBase<K> where TContext : DbContext
    {
        private readonly TContext _dbContext;
        private readonly IUnitOfWork<TContext> _unitOfWork;

        public RepoBase(TContext dbContext, IUnitOfWork<TContext> unitOfWork)
        {
            _dbContext = dbContext == null ? throw new ArgumentNullException(nameof(dbContext)) : dbContext;
            _unitOfWork = unitOfWork == null ? throw new ArgumentNullException(nameof(unitOfWork)) : unitOfWork ;
        }
